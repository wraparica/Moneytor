...
import com.wraparica.moneytor.databinding.ActivityAddExpensesBinding
...
class AddExpensesActivity : AppCompatActivity() {
    ...
    companion object {
        fun getActivityIntent(context: Context): Intent {
            return Intent(context, AddExpensesActivity::class.java)
        }
    }
...
//        }
    ...
    private fun saveExpenses(){
        ...
        db.expensesDao().insertUpdateExpenses(Expenses(db.expensesDao().getNextId(), binding.txtDetails.text.toString(), binding.tvDate.text.toString(), accountId, binding.txtAmount.text.toString().toDouble()))
        db.accountsDao().updateAccountDeductExpense(accountId, binding.txtAmount.text.toString().toDouble())
    }
}